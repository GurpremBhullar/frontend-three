...
import photo1 from "../assets/models.jpg";
import photo2 from "../assets/dressshoe.jpg";
import photo3 from "../assets/glasses.jpg";
...
const dataSlider = [
    {
      ...
      body: {
        cssClasses: "text-white bg-white/10 backdrop-blur-none -skew-x-3 justify-center",
        mainText: "25% OFF",
        subText:
          "Try Our New Member Program",
      },
    },
    {
      id: "2",
